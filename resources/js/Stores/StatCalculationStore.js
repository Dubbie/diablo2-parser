...
export const useStatCalculationStore = defineStore('statCalculation', {
    ...
    actions: {
        ...
        calculateFinalAttributes() {
            ...
            this.attributes.strength = character.attributes.str + character.modified_attributes.str;
            this.attributes.dexterity = character.attributes.dex + character.modified_attributes.dex;
            this.attributes.vitality = character.attributes.vit + character.modified_attributes.vit;
            this.attributes.energy = character.attributes.int + character.modified_attributes.int;
        ...
        calculateFinalResistances() {
            ...
            this.applyModifiers(characterStore.character.equippedItems, this.updateResistances);
        },
