    ...
    private function createData(array $data)
    {
        ...
        foreach ($data as $skillData) {
            ...
            $skillRaw = [
                ...
                'aura_len_calc' => $this->getActualValue($skillData['auralencalc']),
                'aura_range_calc' => $this->getActualValue($skillData['aurarangecalc']),
                'aura_stat_1' => $this->getActualValue($skillData['aurastat1']),
                'aura_stat_2' => $this->getActualValue($skillData['aurastat2']),
                'aura_stat_3' => $this->getActualValue($skillData['aurastat3']),
                'aura_stat_4' => $this->getActualValue($skillData['aurastat4']),
                'aura_stat_5' => $this->getActualValue($skillData['aurastat5']),
                'aura_stat_6' => $this->getActualValue($skillData['aurastat6']),
                'aura_calc_1' => $this->getActualValue($skillData['aurastatcalc1']),
                'aura_calc_2' => $this->getActualValue($skillData['aurastatcalc2']),
                'aura_calc_3' => $this->getActualValue($skillData['aurastatcalc3']),
                'aura_calc_4' => $this->getActualValue($skillData['aurastatcalc4']),
                'aura_calc_5' => $this->getActualValue($skillData['aurastatcalc5']),
                'aura_calc_6' => $this->getActualValue($skillData['aurastatcalc6']),
                ...
                'min_dam' => $this->getActualValue($skillData['MinDam']),
                'min_dam_level_1' => $this->getActualValue($skillData['MinLevDam1']),
                'min_dam_level_2' => $this->getActualValue($skillData['MinLevDam2']),
                'min_dam_level_3' => $this->getActualValue($skillData['MinLevDam3']),
                'min_dam_level_4' => $this->getActualValue($skillData['MinLevDam4']),
                'min_dam_level_5' => $this->getActualValue($skillData['MinLevDam5']),
                'max_dam' => $this->getActualValue($skillData['MaxDam']),
                'max_dam_level_1' => $this->getActualValue($skillData['MaxLevDam1']),
                'max_dam_level_2' => $this->getActualValue($skillData['MaxLevDam2']),
                'max_dam_level_3' => $this->getActualValue($skillData['MaxLevDam3']),
                'max_dam_level_4' => $this->getActualValue($skillData['MaxLevDam4']),
                'max_dam_level_5' => $this->getActualValue($skillData['MaxLevDam5']),
                'dmg_sym_per_calc' => $this->getActualValue($skillData['DmgSymPerCalc']),
