...
const requirementClass = (statData, attribute) => {
    if (
        statData.value.required >
        character.characterClass.modified_attributes[attribute]
    ) {
        return "text-red-500";
    }
    ...
    <div>
        ...
        >
            <div v-show="showingStats">
                <div
                    class="relative"
                    v-for="[stat, data] in Object.entries(attributes)"
                    :key="stat"
                >
                    <div
                        :class="rowClasses"
